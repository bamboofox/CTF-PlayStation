...
print("But this time, there are {}5 boards{}, if the board is dead you can't place an 'X' on it'".format(bold + blue, normal))
...
for i in range(1, 51):
    ...
    notakto = Notakto([empty_board(), empty_board(), empty_board(), empty_board(), empty_board()])
    while True:
        try:
